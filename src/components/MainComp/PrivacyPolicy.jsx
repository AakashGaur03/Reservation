  ...
  return (
    <div>
      <div className="mw620 container">
        <h1 className="fontPolicy">Privacy Policy</h1>
        ...
        <h2 className="">Embedded content from other websites</h2>
        ...
        <h2 className="">Who we share your data with</h2>
        ...
        <h2 className="">How long we retain your data</h2>
        ...
        <h2 className="">What rights you have over your data</h2>
        ...
        <h2 className="">Where your data is sent</h2>
